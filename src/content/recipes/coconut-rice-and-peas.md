...
ingredients:
  ...
  - 1 whole Scotch Bonnet Pepper (whole and unpierced — flavor only, no heat)
...
In Jamaica, "peas" means red kidney beans — the dish is the Sunday staple that pairs with everything from jerk to curry goat. The scotch bonnet goes in whole and unpierced: it gives the pot that floral, fruity perfume without any heat, so kids can eat it. If it bursts while cooking, you fish it out fast. The second rule: use real coconut milk, not "lite" — the fat is what makes the rice glossy and substantive instead of watery.
...
7. **Finish:** Remove the scotch bonnet, scallions, and thyme stems. Fluff gently with a fork. The rice should be tinted pale cream from the coconut, studded with beans, and smell like thyme and allspice.
