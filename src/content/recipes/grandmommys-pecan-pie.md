...
4.  **Layer:** Divide the pecans evenly between the two pie shells. Pour the syrup mixture over the pecans—they will naturally float to the top to create the "Snap" layer.
5.  **Bake:** Bake for 40-45 minutes until the edges are set and the center has a slight, stable wobble (the "Bounce").
