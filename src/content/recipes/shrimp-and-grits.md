...
flavorProfile: [savory, tangy, rich, herbaceous, smoky]
cuisines: [Southern]
role: main
vibe: comfort
prepTime: 20 min
...
totalTime: 60 min
servings: '4'
pairsWith: [charred-broccoli-with-garlic, everyday-arugula-salad]
...
ingredients:
  ...
  - '1 lb (450 g) raw peeled, deveined, tail-off shrimp, weighed after thawing and draining; about 31–40 shrimp in this net quantity'
  - '120 g regular-cut smoked bacon, diced'
  - '1/2 tsp freshly ground black pepper, divided'
  - '1 cup (100 g) thinly sliced scallions, white and green parts separated'
  - '1 large garlic clove, finely minced'
  - '1/4 cup (60 ml) water, for the shrimp pan'
  - '4 tsp fresh lemon juice, divided and partly added to taste'
  - 2 tbsp chopped fresh parsley
description: >-
  Tender shrimp, crisp bacon and scallion-lemon pan juices over rich cheddar grits. The grits
  package determines the cooking schedule; cook the shrimp only when the base is ready.
learning:
  focus: Finish the slow starch before the fast-cooking shrimp
  outcome: >-
    Grits that spread softly across a bowl without gritty centers, springy cooked shrimp,
    crisp bacon and a light lemon-scallion coating rather than a pool of bacon grease.
  ...
  before:
    ...
    - >-
      ...
      shell-on product, buy extra and use the net prepared weight; its package count may give a
      different number per serving. Peeling adds preparation time, and frozen shrimp need
      thawing before the listed schedule begins.
    - >-
      Have all aromatics measured before shrimp cooking starts. A 12-inch skillet cooks the
      shrimp in two roughly 225 g rounds, so each piece lies flat rather than steaming in a pile.
      The bacon supplies the cooking fat: about one tablespoon of rendered fat, plus the thin
      film left in the pan.
  checkpoints:
    - step: 2
      cue: A cooled spoonful has tender corn particles with no hard center, and the mixture moves slowly when the pot is tilted.
      why: Thickness alone does not mean the grits have hydrated. Water can evaporate while the centers remain firm, so taste before adding cheese.
    - step: 3
      cue: Bacon is browned and crisp, and the pan contains a measured tablespoon of fat rather than all the drippings.
      why: The quantity of rendered fat varies by bacon. Controlling it keeps the shrimp topping from becoming greasy before it reaches already rich grits.
    - step: 5
      cue: Shrimp flesh is firm, pearly and opaque through the thickest part, with the largest pieces reaching 145°F / 63°C.
      why: Surface pinkness alone can appear before the center is cooked. Stop by the center cue and temperature; continued frying makes shrimp tough rather than usefully crisp.
    - step: 6
      cue: The pan juices lightly coat the shrimp, and lemon brightens a bite with grits without tasting sharply sour.
      why: A little water lifts the browned bacon residue; lemon is added at the finish and tasted alongside the salty cheese and bacon.
  troubleshooting:
    - problem: Grits are thick but still gritty
      cause: The product needs more cooking, or the pan lost water before the grains softened.
      fix: Add some of the listed hot water in small amounts and continue gently simmering, stirring and tasting. Do not add cheese yet or assume extra blending will replace hydration.
    - problem: Grits are stiff after adding cheese
      cause: Cheese thickens the mixture and the starch firms as it cools.
      fix: Fold in hot water a tablespoon or two at a time until the grits spread softly. Keep gently warm; do not boil hard to force melted cheese back into a smooth texture.
    - problem: Shrimp are rubbery
      cause: They cooked too long, or were kept simmering while the grits and vegetables caught up.
      fix: Serve promptly with the pan juices. More cooking or extra butter cannot restore the original texture; next time finish the base first and remove cooked shrimp while building the brief pan sauce.
    - problem: Topping tastes too salty or greasy
  ...
  substitutions:
    ...
    - ingredient: The named stone-ground grits
      ...
      effect: >-
        ...
        butter and cheese once the grains are tender. Very coarse unsoaked grits can extend this
        main to about two hours, with a different corn texture. The listed sixty-minute schedule
        does not apply.
    - ingredient: 120 g pork bacon
  ...
  timing: >-
    ...
    brief covered hold of about ten minutes is included in that sequence, not an extra
    mandatory rest for the seafood. Different grits, peeling or thawing add time.
  storage: >-
    Keep raw shrimp refrigerated at 40°F / 4°C or below and use within two days of purchase,
    or freeze. Thaw frozen shrimp overnight in the refrigerator, or in a sealed bag in cold
    water when preparing them to cook promptly. Refrigerate cooked grits, shrimp and bacon
    separately in shallow containers within two hours, or one hour above 90°F / 32°C.
    Use within three to four days. Reheat cooked leftovers to 165°F / 74°C, loosening grits
    with a little water and heating shrimp briefly at the end; their texture will be firmer.
    For a short service hold, keep grits covered above 140°F / 60°C with occasional stirring,
  ...
  sources:
    ...
    - title: Anson Mills — Coarse-grits hydration and much longer cooking schedule
      url: https://ansonmills.com/recipes/489
    - title: Quaker — Quick grits product preparation
      url: https://www.quakeroats.com/products/hot-cereals/grits/quick-grits
    - title: FDA — Raw seafood storage, thawing and shrimp cooking endpoints
      url: https://www.fda.gov/food/buy-store-serve-safe-food/selecting-and-serving-fresh-and-frozen-seafood-safely
    - title: FoodSafety.gov — Temperature control, holding and prompt cooling
      url: https://www.foodsafety.gov/keep-food-safe/4-steps-to-food-safety
    - title: FoodSafety.gov — Safe internal temperatures for cooked leftovers
      url: https://www.foodsafety.gov/food-safety-charts/safe-minimum-internal-temperatures
    - title: FoodSafety.gov — Three-to-four-day leftover guidance
...
This Southern bowl combines cheddar grits, bacon and shrimp with scallions and lemon. The bacon provides crunch while the shrimp should stay tender. Stone-ground grits vary substantially by mill and particle size, so finish their hydration before starting the quick shrimp stage.
...
6. **Make a brief pan coating:** Reduce heat to medium-low. Add scallion whites to the fat film and stir for about one minute, then add garlic for about thirty seconds without browning it. If the pan looks dry, use a teaspoon from the measured pan water while the scallions soften. Add the rest of the separate quarter-cup pan water and scrape up brown, not black, residue; simmer for thirty to sixty seconds. Turn off heat and stir in three teaspoons lemon juice, most of the scallion greens, parsley and the shrimp's half of the pepper. Return shrimp and any juices just long enough to coat. Taste a shrimp with a little grit and add the remaining teaspoon lemon only if needed. Do not salt the topping automatically; bacon and cheese already contribute seasoning.
7. **Serve promptly:** Divide grits among four bowls, top with shrimp and the light pan juices, then scatter over crisp bacon and the reserved scallion greens. Distribute shrimp evenly, roughly eight to ten per bowl for the stated size. Serve a vegetable alongside; the grits provide the starch for the plate.
