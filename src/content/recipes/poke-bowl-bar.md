---
title: 'Poke Bowl Bar (Build-Your-Own)'
origin: Hawaii
difficulty: intermediate
cookingMethods: [no-cook]
dietary: []
occasions: [entertaining, date-night, weekend-dinner, light-and-fresh]
...
leftovers: poor
advancePrep: [prep-toppings, make-dressing]
equipment: [cutting-board, mixing-bowls, serving-bowls]
pairsWith:
  - master-sushi-rice
...
ingredients:
  - '--- The Fish (Choose 1-2) ---'
  - '1.5 lbs Sashimi-Grade Ahi Tuna (cut into 1/2-inch cubes)'
  - '1 lb Sashimi-Grade Wild Salmon (cut into 1/2-inch cubes)'
  - '1 lb Scallops (large, sliced thin)'
  - '--- The Marinades (Choose 1-2) ---'
  ...
  - '1 tsp Sesame Seeds'
  - '--- The Grain Base ---'
  - '2 cups Cooked Sushi Rice (at room temperature)'
  - '2 cups Cooked White Rice (jasmine or short-grain)'
  - '--- The Vegetables (Fresh, raw, or marinated) ---'
  - '1 Avocado (sliced, dressed with lime and salt)'
  - 'Korean Pickled Cucumbers (drained and chilled)'
  ...
  - '--- The Garnishes ---'
  - 'Shredded Nori (Seaweed), cut into strips'
  - '2 tbsp Toasted White Sesame Seeds'
  - '2 tbsp Toasted Black Sesame Seeds'
  - 'Sliced Scallions'
  - 'Microgreens or Cilantro (optional)'
  - 'Furikake Seasoning (optional, for umami depth)'
...
3. **Marinate the Fish (Not more than 10 minutes before serving):** Gently fold the cubed fish into the marinade. Transfer to a bowl and refrigerate until ready to serve. The fish should stay cold until plating. If making more than 30 minutes in advance, keep the marinade and fish separate and combine just before serving.

4. **Prep All Vegetables:** Slice avocado and dress immediately with fresh lime juice and a pinch of salt. Drain pickled cucumbers and keep chilled. Make sure edamame are chilled. Dice cucumber, shred carrot, and slice radishes.

5. **Arrange the Bar:** Set up a station with the following in separate bowls:
   - Sushi rice (room temperature)
   - White rice (room temperature)
   - Marinated fish in its marinade
   - Avocado (keep separate until the last moment)
   - All fresh vegetables in individual bowls
   - Nori strips, sesame seeds (separate white and black), scallions
   - Soy sauce and sriracha on the side

### Assembly (2 minutes per bowl)

6. **The Base:** Spoon 1/2 cup sushi rice into each bowl. Pat it down gently so it holds together.

7. **The Fish:** Using a slotted spoon, place 1/4 of the marinated fish and a spoonful of the marinade directly on the rice (off to one side).

8. **The Vegetables:** Arrange avocado slices, cucumber, edamame, and other raw vegetables in sections around the fish.

9. **The Toppings:** Scatter nori strips, toasted sesame seeds (white and black), scallions, and microgreens over everything.

10. **The Finish:** Drizzle a touch of extra sesame oil if desired. Serve with soy sauce and sriracha on the side for individual heat adjustment.
