---
title: Lamb Pitas and Greek Village Salad
template: plate
...
Allow about **75 minutes elapsed and 55 minutes active** for one cook using a skillet that holds two patties at a time. Use the oven to warm all four pitas while the second pair cooks. A large grill or griddle can shorten the batch work, but the meat’s measured endpoint still controls when dinner is ready.
...
5. **Dress and assemble:** After the burgers are cooked, toss the salad with its measured oil, initial vinegar and oregano, add olives and feta, then taste before adding any optional salt or extra vinegar. Stir and taste the mint yogurt. Start with 2–3 tablespoons inside each pita, add one patty, and offer extra sauce separately. Divide the full salad into four generous sides and serve promptly.
...
The couscous needs about twenty minutes including preparation and finishing, not just five minutes on a timer. Prepare its lemon and herbs with the salad vegetables, then heat and hydrate the grain on a separate burner during the second burger batch. Fluff and finish before dressing the salad. Allow **80–85 minutes** for one cook so the extra measuring, hydration checks and finishing are included. This is a Mediterranean-inspired menu variation, not a claim that instant couscous is a traditional Greek burger accompaniment.
