...
Read the complete original meal, cooked-protein taco bar and esquites. The meal pointed to carnitas-bowl rather than tacos, repeated rice/guacamole components and scheduled a slow cooker with no matching recipe method. Replaced the main reference with the actual cooked-chicken taco bar, retaining a cooked-pork option with one combined 600 g cooked-protein quantity. This is six people/eighteen small tacos plus one six-side corn recipe. Both required components are individually reviewed with no pending required subrecipes.

The plan explicitly starts from cooked meat and its storage age; raw carnitas preparation is not hidden inside a weeknight headline. Cabbage, radish, avocado and salsa are already included in the main. Separate rice, guacamole and invented beans would duplicate its roles. Oil, lime and dairy belong to distinct measured component allocations.
